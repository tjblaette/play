...
class Network():
    def __init__(self, state_space_dim, action_space_dim, chkpt_dir="training"):
        ...
        state_space_dim (int, int): Dimension tuple of the World to model,
            corresponds to the number of input units of the network.
        action_space_dim (int): Number of actions in snake.STATE_SPACE,
            corresponds to the number of output units of the network.
        chkpt_dir (str): Name of the directory in which to save the model
            after training.
        """
    ...
    def predict(self, state, action):
        ...
        Returns:
            ...
            in the same form as the input action array.
